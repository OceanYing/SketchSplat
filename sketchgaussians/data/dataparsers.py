...
from sketchgaussians.utils.colmap_read_write_model import read_cameras_binary, read_cameras_text, read_images_binary, read_images_text
from sketchgaussians.cameras.cameras import Camera, OpenCVCamera
...
class ColmapDataParser(DataParser):
    ...
    def load_views(self, images_dir: str, rgb_dir: str,
        ...
        for imid in images:
            ...
            if rgb_dir != None:
                view["rgb"] = self.load_image(rgb_dir, image_name)
...
class EMAPDataParser(DataParser):
    ...
    def load_views(self, images_dir: str, rgb_dir: str):
        ...
        for frame in frames:
            ...
            view = {"camera" : camera, "image" : image}
            if rgb_dir != None:
                view["rgb"] = self.load_image(rgb_dir, imname)
            self.views.append(view)
