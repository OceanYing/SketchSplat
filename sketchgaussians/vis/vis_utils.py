...
from sketchgaussians.utils.colmap_read_write_model import qvec2rotmat
from sketchgaussians.utils.misc_utils import get_major_directions_from_scales_quats
